  ...
  const createElection = async () => {
    try {
      ...
      await factoryContract.methods
        .createElection(email, fullMetadataUrl)
        .send({
          from: account,
        });
    } catch (err) {
    ...
    try {
      await axios
        ...
        .then((res) => {
          setElections([
            ...elections,
            ...res.data.data.ethereum.smartContractEvents,
          ]);
        })
        console.log("this is setting elections",elections)
    } catch (err) {}
  };
  ...
  return (
    <section className="flex">
      ...
      <main className="ml-24 p-5 w-full">
        <div className="text-right space-x-2 flex-col w-full">
          <button
          ...
          {/* <button
            ...
            onClick={() => setRemoveElectionModal(true)}
          >
            Remove Election
          </button> */}
        </div>
      ...
      {/* <input
        ...
        className="modal-toggle"
        checked={removeElectionModal}
        readOnly
      />
      <div className="modal">
        <div className="modal-box">
          <h3 className="font-bold text-lg">Remove Election</h3>
